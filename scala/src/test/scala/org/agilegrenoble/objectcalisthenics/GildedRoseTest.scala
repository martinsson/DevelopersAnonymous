...
class GildedRoseTest extends FlatSpec with ShouldMatchers with BeforeAndAfter {
  ...
  it should "have repeated value of containsOnlybackstage passes" in {
    ...
    val sellIns = items.map(_.sellIn)
    sellIns should containOnly(List(
        1, 18, -7, 6, 8, 16, -8, 6, 4, -9, 4, -2, -9, 8, 14, 7, 9, -9, 12, 2, -9, 12, -7, 5, -6,
        -1, -11, 2, -4, 9,4, 15, 13, -4, -4, 12, -7, 9, -4, -7, 4, 0, 11, 6, -8, 3, 17, 12, 9, -4, 
        13, -5, 10, 4, 14, 6, 14, 1, -5, -3, 15, 11, -2, -6, -2, 2, -11, 17, 10, 18, 2, 14, -8, -5, 1, -1, 0, 
        14, 7, 9, -3, 2, -9, -1, -6, 5, -5, 8, -5, 11, 3, 17, 17, 13, 5, 11, 16, -3, 6, 11))
  }
